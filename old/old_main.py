# https://github.com/stefyy47/BotGladiatus
...
def buy_right_items_auction2(pret_maxim, item, itemType, itemLVL, quality):
    try:
        res = s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&ttype=3&sh={secureHash}',
        ...
        while i != -1:
            ...
            if pret_maxim >= pret_int and i2 == - 1:
                ...
                s.post(
                    f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&submod=placeBid&ttype=3&rubyAmount=3&sh={secureHash}',
...
def buy_right_items_auction1(pret_maxim, item, itemType, itemLVL, quality):
    try:
        res = s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&sh={secureHash}',
                     data={'doll': 1, 'qry': item, 'itemLevel': itemLVL, 'itemType': itemType, 'itemQuality': quality})
        i = res.text.find('mic pret')
        while i != -1:
            i2 = res.text.find('Lul', i - 150, i)
            ...
            if pret_maxim >= pret_int and i2 == - 1:
                print("Am pus bid pentru itemul(Gladiator auction)", item)
                s.post(
                    f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&submod=placeBid&ttype=2&rubyAmount=3&sh={secureHash}',
                    data={'auctionid': id_item, 'qry': "", 'itemType': itemType, 'itemLevel': itemLVL, 'itemQuality': quality,
                          'buyouthd': 0, 'bid_amount': pret, 'bid': 'Ofera'})
            i = res.text.find('mic pret', i)
        return 0
...
def check_auction1_for_item(pret_maxim, types, itemLVL, quality, *items):
    try:
        ...
        for item in items:
            res = s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&sh={secureHash}', data = {'doll' : 1, 'qry' : item, 'itemLevel' : 22, 'itemType': 0, 'itemQuality' : -1})
            i = res.text.find("Nici un rezultat")
            if i == -1:
                res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&sh={secureHash}')
                ...
                while res.text[timp_ramas] == 'f' and res.text[timp_ramas + 7] == 's':
                    ...
                    res = s.get(
                        f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&sh={secureHash}')
                    timp_ramas = res.text.find('description_span_right')
                    while res.text[timp_ramas] != '<' or res.text[timp_ramas + 1] != 'b' or res.text[timp_ramas + 2] != '>':
                        timp_ramas += 1
                    timp_ramas += 3
...
def check_auction2_for_item(pret_maxim, types, itemLVL, quality, *items):
    try:
        ...
        for item in items:
            res = s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&ttype=3&sh={secureHash}', data = {'doll' : 1, 'qry' : item, 'itemLevel' : 22, 'itemType': 0, 'itemQuality' : -1})
            i = res.text.find("Nici un rezultat")
            if i == -1:
                res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&ttype=3&sh={secureHash}')
                timp_ramas = res.text.find('description_span_right')
                while res.text[timp_ramas] != '<' or res.text[timp_ramas + 1] != 'b' or res.text[timp_ramas + 2] != '>':
                    timp_ramas += 1
                timp_ramas += 3
                while res.text[timp_ramas] == 'f' and res.text[timp_ramas + 7] == 's':
                    ...
                    res = s.get(
                        f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&ttype=3&sh={secureHash}')
                    timp_ramas = res.text.find('description_span_right')
...
def place_food_in_inventory():
    try:
        ...
        for i in range(1,6):
            for j in range (1,9):
                millis = int(round(time.time() * 1000))
                res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=packages&f=7&fq=-1&qry=&page=1&sh={secureHash}')
                soup = BeautifulSoup(res.text, 'html5lib')
                supa = soup.find('input', attrs={'name' : 'packages[]'})['value']
                s.post(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=-{supa}&fromX=1&fromY=1&to=512&toX={i}&toY={j}&amount=1', data = {'a' : millis, 'sh' : secureHash})
    except:
        pass
def buy_mercenaries(pret_maxim, name, quality, level):
    try:
        ...
        if res.text[timp_ramas] == 'f' and res.text[timp_ramas + 7] == 's':
            res = s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&sh={secureHash}', data = {'doll' : 1, 'qry' : name, 'itemLevel' : level, 'itemType' : 15, 'itemQuality' : quality})
            i = 0
            while i != -1:
                if name == 'samnit' or name == 'murmil':
                    ...
                    if int(dexteritatea) >= 380:
                        ...
                        if pret_maxim >= pret_int and i2 == - 1:
                            ...
                            s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&submod=placeBid&ttype=2&rubyAmount=3&sh={secureHash}', data = {'auctionid' : {id_item}, 'qry' : name, 'itemType' : 15, 'itemLevel' : level, 'itemQuality' : -1, 'buyouthd' : 0, 'bid_amount': {pret}, 'bid': 'Ofera'})
...
def buy_food_auction(pret_maxim):
    try:
        ...
        timp_ramas += 3
        if res.text[timp_ramas] == 'f' and res.text[timp_ramas + 7] == 's':
            res = s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&sh={secureHash}', data = {'doll' : 1, 'qry' : "", 'itemLevel' : 19, 'itemType' : 7, 'itemQuality' : -1})
            i = res.text.find('mic pret')
            while i != -1:
                i2 = res.text.find('Lul', i - 150, i)
                while res.text[i] != ':':
                ...
                if pret_maxim >= pret_int and i2 == - 1:
                    ...
                    s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=auction&submod=placeBid&ttype=2&rubyAmount=3&sh={secureHash}', data = {'auctionid' : {id_item}, 'qry' : "", 'itemType' : 7, 'itemLevel' : 19, 'itemQuality' : -1, 'buyouthd' : 0, 'bid_amount': {pret}, 'bid': 'Ofera'})
                i = res.text.find('mic pret', i)
    except:
        pass
def check_market():
    ...
    try:
        res = s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=market&sh={secureHash}',
    ...
    try:
        for i in range(1,6):
            for j in range (1,9):
                ...
                soup = BeautifulSoup(res.text, 'html5lib')
                supa = soup.find('input', attrs={'name' : 'packages[]'})['value']
                s.post(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=-{supa}&fromX=1&fromY=1&to=514&toX={i}&toY={j}&amount=3', data = {'a' : millis, 'sh' : secureHash})
...
def go_smeltery():
    ...
    for x in range(6):
        try:
            millis = int(round(time.time() * 1000))
            s.post(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php', data = {'mod' : 'forge', 'submod' : 'lootbox', 'mode' : 'smelting', 'slot' : x, 'a' : millis , 'sh' : secureHash})
            ...
            while res.text[id] != '"':
                id_item += res.text[id]
                id += 1
            s.post('https://s28-en.gladiatus.gameforge.com/game/ajax.php', data = {'mod' : 'forge', 'submod' : 'getSmeltingPreview', 'mode' : 'smelting', 'slot' : x, 'iid' : id_item , 'amount' : 2,'a' : millis , 'sh' : secureHash})
            s.post('https://s28-en.gladiatus.gameforge.com/game/ajax.php', data = {'mod' : 'forge', 'submod' : 'rent', 'mode' : 'smelting', 'slot' : x, 'rent' : 2, 'item' : id_item, 'a' : millis , 'sh' : secureHash})
        except:
...
def money_in_bank():
    try:
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=guildBankingHouse&sh={secureHash}')
        ...
        if money > 100000:
            s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=guildBankingHouse&submod=donate&sh={secureHash}', data = {'donation':money, 'doDonation':'Doneaza'})
    except:
...
def try_banclucru(x):
    ...
    barrier.wait()
    try:
        # s.post('https://s28-en.gladiatus.gameforge.com/game/ajax.php', data={'mod': 'forge', 'submod': 'cancel', 'mode': 'workbench', 'slot': x, 'a': millis,
        #                  'sh': secureHash})
...
def go_work(work_url):
    ...
    try:
        print("Going to work!")
        response = driver.request('POST', work_url, data = data_work)
        ...
        print("Working for {} seconds!".format(time_working))
        return time_working
...
def go_circus_provinciarum(nivel_cautare):
    try:
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=arena&submod=serverArena&aType=3&sh={secureHash}')
        i2 = 0
        OK = 0
        ...
        try:
            for x in range(5):
                ...
                if nivel_oponent < nivel_cautare:
                    ...
                    s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=arena&submod=doCombat&aType=3&opponentId={id_player}&serverId={id_server}&country=ro&a={millis}&sh={secureHash}')
                    print("Am terminat circus_provinciarum")
            #if OK == 0:
                #print("Am resetat circus_provinciarum")
            s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=arena&submod=getNewOpponents&aType=3&sh={secureHash}', data = {'actionButton' :	'Caută+Oponenţi'})
        except:
...
def go_arena_provinciarum(nivel_cautare):
    try:
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=arena&submod=serverArena&aType=2&sh={secureHash}')
        i2 = 0
        OK = 0
        i2 = res.text.find('Provincie</th')
            ...
            for x in range(5):
                ...
                if nivel_oponent < nivel_cautare:
                    ...
                    while res.text[i] != '"':
                        ...
                        i += 1
                    id_player = int(id_player_temp)
                    s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=arena&submod=doCombat&aType=2&opponentId={id_player}&serverId={id_server}&country=ro&a={millis}&sh={secureHash}')
                    print("Am terminat arena_proviciarum")

            #if OK == 0:
            #print("Am resetat arena_provinciarum")
            s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=arena&submod=getNewOpponents&aType=2&sh={secureHash}', data = {'actionButton' :	'Caută+Oponenţi'})
        except:
...
def go_arena(loc_arena_bataie):
    millis = int(round(time.time() * 1000))
    try:
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=arena&sh={secureHash}')
        if loc_arena_bataie > 0 :
            ...
            s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doArenaFight.php?did={player}&a={millis}&sh={secureHash}')
            loc_arena_bataie -= 1
...
def go_dungeon_Sasama_Last_Journey():
    ...
    millis = int(round(time.time() * 1000))
    try:
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=4&sh={secureHash}',
               data={'dif2': 'Avansat'})
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=4&sh={secureHash}')
        ...
        for x in range(1, 8):
            s.get(
                f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi={x}&a={millis}&sh={secureHash}')
...
def go_dungeon_heart_decay():
    ...
    millis = int(round(time.time() * 1000))
    try:
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=3&sh={secureHash}',
               data={'dif2': 'Avansat'})
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=3&sh={secureHash}')
        i = res.text.find('dungeonId')
        dungeonID = ""
        dungeonID += res.text[i + 18]
        dungeonID += res.text[i + 19]
...
def go_dungeon_In_Enemy_Hands():
    ...
    millis = int(round(time.time() * 1000))
    try:
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=5&sh={secureHash}',
               data={'dif1': 'Normal'})
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=5&sh={secureHash}')
        i = res.text.find('dungeonId')
        dungeonID = ""
        dungeonID += res.text[i + 18]
        dungeonID += res.text[i + 19]
...
def go_dungeon_Portul_Pierdut():
    ...
    try:
        ...
        for position in range(1, 10):
            s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi={position}&a={millis}&sh={secureHash}')
...
def go_dungeon_The_Last_Resort():
    ...
    millis = int(round(time.time() * 1000))
    try:
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=1&sh={secureHash}',
               data={'dif2': 'Avansat'})
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=1&sh={secureHash}')
        i = res.text.find('dungeonId')
        dungeonID = ""
        dungeonID += res.text[i + 18]
        dungeonID += res.text[i + 19]
...
def go_dungeon_Blood_Cavern():
    ...
    millis = int(round(time.time() * 1000))
    try:
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=2&sh={secureHash}', data = {'dif1' : 'Normal'})
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=2&sh={secureHash}')
        i = res.text.find('dungeonId')
        dungeonID = ""
        dungeonID += res.text[i + 18]
        dungeonID += res.text[i + 19]
        ...
        dungeonID += res.text[i + 21]
        dungeonID += res.text[i + 22]
        s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=1&a={millis}&sh={secureHash}')
        ...
        if fulfilledOrNot != -1:
            s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=2&a={millis}&sh={secureHash}')
        fulfilledOrNot = res.text.find("Gaseste piatra verde")
        fulfilledOrNot = res.text.find("nerealizat", fulfilledOrNot, fulfilledOrNot + 150)
        if fulfilledOrNot != -1:
            s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=3&a={millis}&sh={secureHash}')
        fulfilledOrNot = res.text.find("Gaseste piatra albastra")
        fulfilledOrNot = res.text.find("nerealizat", fulfilledOrNot, fulfilledOrNot + 150)
        if fulfilledOrNot != -1:
            s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=4&a={millis}&sh={secureHash}')
        s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=6&a={millis}&sh={secureHash}')
    except:
        pass
def go_dungeon_Viking_Town():
    ...
    try:
        ...
        dungeonID += res.text[i + 22]
        s.get(
        f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=1&a={millis}&sh={secureHash}')
        s.get(
            f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=2&a={millis}&sh={secureHash}')
        s.get(
            f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=3&a={millis}&sh={secureHash}')
        s.get(
            f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=4&a={millis}&sh={secureHash}')
        s.get(
        f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=5&a={millis}&sh={secureHash}')
...
def go_dungeon_Dark_Intrigue():
    ...
    millis = int(round(time.time() * 1000))
    try:
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=3&sh={secureHash}', data = {'dif1' : 'Normal'})
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=3&sh={secureHash}')
        i = res.text.find('dungeonId')
        dungeonID = ""
        dungeonID += res.text[i + 18]
...
def go_dungeon_PEFUGA():
    ...
    millis = int(round(time.time() * 1000))
    try:
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=1&sh={secureHash}', data = {'dif1' : 'Normal'})
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=1&sh={secureHash}')
        i = res.text.find('dungeonId')
        dungeonID = ""
        dungeonID += res.text[i + 18]
        ...
        dungeonID += res.text[i + 21]
        dungeonID += res.text[i + 22]
        s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=8&a={millis}&sh={secureHash}')
        s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=7&a={millis}&sh={secureHash}')
        s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=2&a={millis}&sh={secureHash}')
        s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=1&a={millis}&sh={secureHash}')
        s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=3&a={millis}&sh={secureHash}')
        s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=6&a={millis}&sh={secureHash}')
        s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=5&a={millis}&sh={secureHash}')
        s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doDungeonFight.php?did={dungeonID}&posi=4&a={millis}&sh={secureHash}')
...
def go_dungeon_Hidden_Grave():
    ...
    millis = int(round(time.time() * 1000))
    try:
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=4&sh={secureHash}', data = {'dif1' : 'Normal'})
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=4&sh={secureHash}')
        i = res.text.find('dungeonId')
        dungeonID = ""
        dungeonID += res.text[i + 18]
...
def go_dungeon_The_True_Owner():
    ...
    millis = int(round(time.time() * 1000))
    try:
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=2&sh={secureHash}', data = {'dif2' : 'Avansat'})
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=2&sh={secureHash}')
        i = res.text.find('dungeonId')
        dungeonID = ""
        dungeonID += res.text[i + 18]
...
def go_dungeon_gustavo():
    ...
    millis = int(round(time.time() * 1000))
    try:
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=0&sh={secureHash}', data = {'dif1' : 'Normal'})
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=dungeon&loc=0&sh={secureHash}')
        i = res.text.find('dungeonId')
        dungeonID = ""
        dungeonID += res.text[i + 18]
        dungeonID += res.text[i + 19]
...
def repair_items(doll):
    try:
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=overview&doll={doll}&sh={secureHash}')
        if doll == 1:
...
def repair_eq_items(doll):
    ...
    try:
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=3&fromX=1&fromY=1&to=514&toX=1&toY=1&amount=1&doll={doll}', data = {'a':millis,'sh':secureHash})
        s.post(
            f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=9&fromX=1&fromY=1&to=514&toX=1&toY=4&amount=1&doll={doll}',
            data={'a': millis, 'sh': secureHash})
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=5&fromX=1&fromY=1&to=514&toX=3&toY=1&amount=1&doll={doll}'
            ,data={'a': millis, 'sh': secureHash})
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=10&fromX=1&fromY=1&to=514&toX=3&toY=4&amount=1&doll={doll}'
            , data={'a': millis, 'sh': secureHash})
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=2&fromX=1&fromY=1&to=514&toX=5&toY=1&amount=1&doll={doll}'
            , data={'a': millis, 'sh': secureHash})
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=4&fromX=1&fromY=1&to=514&toX=5&toY=3&amount=1&doll={doll}'
            , data={'a': millis, 'sh': secureHash})
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=6&fromX=1&fromY=1&to=514&toX=5&toY=5&amount=1&doll={doll}'
            , data={'a': millis, 'sh': secureHash})
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=7&fromX=1&fromY=1&to=514&toX=6&toY=5&amount=1&doll={doll}'
            , data={'a': millis, 'sh': secureHash})
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=11&fromX=1&fromY=1&to=514&toX=7&toY=1&amount=1&doll={doll}'
            , data={'a': millis, 'sh': secureHash})
        res = s.post(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php',
                     data={'mod': 'inventory', 'submod': 'loadBag', 'bag': 514, 'shopType': 0, 'a': millis,
                           'sh': secureHash})
        ...
        while x != -1:
            ...
            if x != -1:
                ...
                item_ids.append(id)
        for i in range(6):
            s.post('https://s28-en.gladiatus.gameforge.com/game/ajax.php', data = {'mod':'forge','submod':'rent','mode':'workbench','slot':i,'rent':2,'item':int(item_ids[i]),'a':millis,'sh':secureHash})
            s.post('https://s28-en.gladiatus.gameforge.com/game/ajax.php', data = {'mod':'forge','submod':'storageToWarehouse','mode':'workbench','slot':i,'quality':0,'a':millis,'sh':secureHash})
            s.post('https://s28-en.gladiatus.gameforge.com/game/ajax.php', data = {'mod':'forge','submod':'start','mode':'workbench','slot':i,'a':millis,'sh':secureHash})

        time.sleep(7)
        for i in range(6):
            s.post('https://s28-en.gladiatus.gameforge.com/game/ajax.php', data = {'mod':'forge','submod':'lootbox','mode':'workbench','slot':i,'a':millis,'sh':secureHash})
        ...
        for i in range(9):
            res = s.get(
                f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=packages&f=0&fq=-1&qry=&page=1&sh={secureHash}')
            soup = BeautifulSoup(res.text, 'html5lib')
            supa = soup.find('input', attrs={'name': 'packages[]'})['value']
            s.post(
                f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=-{supa}&fromX=1&fromY=1&to=514&toX={vect_x[i]}&toY={vect_y[i]}&amount=1',
                data={'a': millis, 'sh': secureHash})
        s.post(f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=514&fromX=1&fromY=1&to=11&toX=1&toY=1&amount=1&doll={doll}', data = {'a':millis, 'sh':secureHash})
        s.post(
            f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=514&fromX=1&fromY=2&to=6&toX=1&toY=1&amount=1&doll={doll}',
            data={'a': millis, 'sh': secureHash})
        s.post(
            f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=514&fromX=1&fromY=3&to=7&toX=1&toY=1&amount=1&doll={doll}',
            data={'a': millis, 'sh': secureHash})
        s.post(
            f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=514&fromX=2&fromY=1&to=4&toX=1&toY=1&amount=1&doll={doll}',
            data={'a': millis, 'sh': secureHash})
        s.post(
            f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=514&fromX=6&fromY=1&to=10&toX=1&toY=1&amount=1&doll={doll}',
            data={'a': millis, 'sh': secureHash})
        s.post(
            f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=514&fromX=4&fromY=3&to=9&toX=1&toY=1&amount=1&doll={doll}',
            data={'a': millis, 'sh': secureHash})
        s.post(
            f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=514&fromX=2&fromY=3&to=5&toX=1&toY=1&amount=1&doll={doll}',
            data={'a': millis, 'sh': secureHash})
        s.post(
            f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=514&fromX=4&fromY=1&to=2&toX=1&toY=1&amount=1&doll={doll}',
            data={'a': millis, 'sh': secureHash})
        s.post(
            f'https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=514&fromX=6&fromY=3&to=3&toX=1&toY=1&amount=1&doll={doll}',
            data={'a': millis, 'sh': secureHash})
    except:
    ...
    return 0
def get_hp():
    res = s.get(f"https://s28-en.gladiatus.gameforge.com/game/index.php?mod=location&loc=0&sh={secureHash}")
    global driver
    soup = BeautifulSoup(res.text, 'html5lib')
...
def eat():
    ...
    try:
        ...
        if puncte_ramase_hp <= 50:
            ...
            res = s.post(f"https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=512&fromX={res.text[i2]}&fromY={res.text[i3]}&to=8&toX=1&toY=1&amount=1&doll=1", data=data_eat)
...
def ataca_pe_edu():
    ...
    try:
        eat()
        if get_hp() >= 70:
            s.get(f'https://s28-en.gladiatus.gameforge.com/game/ajax/doArenaFight.php?did=16120&a={millis}&sh={secureHash}')
    except:
...
def accept_quests():
    ...
    try:
        res = s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=quests&sh={secureHash}')
            ...
            while i != -1:
                ...
                if i != -1 and res.text.find("slot_progress", i, i + 300) == -1:
                    ...
                    try:
                        ...
                        pass
                    s.get(
                        f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=quests&submod=startQuest&questPos={nr}&sh={secureHash}')
                    OK = 1
                    #return
                elif i != -1:
                    i += 1
        ...
        return
    if OK == 0:
        s.get(f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=quests&submod=resetQuests&sh={secureHash}')
    ...
    try:
        while i != -1:
            ...
            try:
                ...
                pass
            s.get(
                f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=quests&submod=finishQuest&questPos={nr}&sh={secureHash}')
    except:
    ...
    try:
        while i != -1:
            ...
            try:
                ...
                pass
            s.get(
                f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=quests&submod=restartQuest&questPos={nr}&sh={secureHash}')
    except:
        print("Nu am reusit restart_quests")
    print("Am terminat restart_quests")
def get_xp():
    res = s.get(f"https://s28-en.gladiatus.gameforge.com/game/index.php?mod=packages&sh={secureHash}")
...
def mergi_la_expeditii(loc_arena_bataie):
    ...
    try:
        ...
        eat()
        adventure_url = f"https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=location&submod=attack&location=4&stage=4&premium=0&a={millis}&sh={secureHash}"
        res = s.get(f"https://s28-en.gladiatus.gameforge.com/game/index.php?mod=packages&sh={secureHash}")
        soup = BeautifulSoup(res.text, 'html5lib')
...
login_data = {
    ...
    'login_server' : 's28-en.gladiatus.gameforge.com/game/index.php?mod=start&submod=login'
}
data_eat ={
    'a' : '',
    'sh' : ''
...
with Firefox() as driver:
    ...
    url = 'https://en.gladiatus.gameforge.com/game/'
    login_url = 'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=start&submod=login'
    ...
    # driver = Firefox()
    driver.get('https://lobby.gladiatus.gameforge.com/en_GB/')
    ...
    driver.find_element_by_xpath('//input[@name="email"]').send_keys('uberpowsteam@gmail.com')
    driver.find_element_by_xpath('//input[@name="password"]').send_keys('321478965')
    driver.find_element_by_xpath('//button[@type="submit"]').click()

    WebDriverWait(driver, 10).until(lambda x: x.find_element_by_xpath('//span[@class="serverDetails"]')).click()
    driver.switch_to.window(driver.window_handles[1])

    time.sleep(10) # fix into an elegant solution, gotta wait for 'secretHash' in JS to be defined
    secureHash = get_hash(driver.page_source)

    """

    starting_page_url = f"https://s28-en.gladiatus.gameforge.com/game/index.php?mod=location&loc=0&sh={secureHash}"
    adventure_url = f"https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=location&submod=attack&location=1&stage=2&premium=0&a=1554983095452&sh={secureHash}"
    load_bag_url = 'https://s28-en.gladiatus.gameforge.com/game/ajax.php'
    ...
    eat_url = f"https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=512&fromX={1}&fromY={1}&to=8&toX=1&toY=1&amount=1&doll=1"
    place_in_inventory_url = f"https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=-763582&fromX=1&fromY=1&to=512&toX={1}&toY={1}&amount=1"
    work_url = f'https://s28-en.gladiatus.gameforge.com/game/index.php?mod=work&submod=start&sh={secureHash}'
    res = s.get(f"https://s28-en.gladiatus.gameforge.com/game/index.php?mod=packages&sh={secureHash}")
...
"""
    ...
    while soup.find('input', attrs={'name' : 'packages[]'})['value'] != 0 and numar < 100:
        ...
        for i in range(1,6):
            for j in range(1,9):
                place_in_inventory_url = f"https://s28-en.gladiatus.gameforge.com/game/ajax.php?mod=inventory&submod=move&from=-{supa}&fromX=1&fromY=1&to=512&toX={i}&toY={j}&amount=1"
